...
$factory->define(Consumer::class, function (Faker $faker) {
    ...
    if($account_type == 0){
        ...
        $consumer_data = [
            ...
            'operator_name_2' => $faker->name,
            'operator_tel_2' => $faker->randomElement(['02', '03', '04', '05', '06']) . str_pad($faker->numberBetween(100000, 999999), 6, '0', STR_PAD_LEFT),
            'operator_phone_2' => $faker->bothify('09########'),
            'operator_email_2' => $faker->unique()->safeEmail,
