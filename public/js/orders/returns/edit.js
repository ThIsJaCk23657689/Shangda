...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Orders/ReturnUpdateForm.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Orders/ReturnUpdateForm.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updateReturnOrder: function updateReturnOrder(e) {
      // 檢查是否有新增原物料在進貨單內。
      ...
      // 1. 先創建 ReturnOrder
      var url = $('#updateReturnOrder').text();
      ...
      axios.patch(url, data).then(function (response) {
        ...
        var detailURL = $('#updateReturnOrderDetail').text();
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Orders/ReturnUpdateForm.vue?vue&type=template&id=642fef28&":
/*!********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Orders/ReturnUpdateForm.vue?vue&type=template&id=642fef28& ***!
  \********************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.updateReturnOrder.apply(null, arguments);
      }
    }
  }, [_c("input", {
    attrs: {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.returnOrder.consumer_id,
      expression: "returnOrder.consumer_id"
    }],
    staticClass: "form-control",
    attrs: {
      id: "consumer_id",
    ...
    on: {
      change: [function ($event) {
        ...
        _vm.$set(_vm.returnOrder, "consumer_id", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }, _vm.getConsumerData]
    }
  }, [_c("option", {
    attrs: {
  ...
  }, [_vm._v("請選擇...")]), _vm._v(" "), _vm._l(_vm.consumers, function (data) {
  ...
  }, [_vm._v("退貨單編號")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.returnOrder.shown_id,
      expression: "returnOrder.shown_id"
    }],
    staticClass: "form-control",
    attrs: {
      id: "shownID",
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.returnOrder, "shown_id", $event.target.value);
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "col-md-2"
  ...
  }, [_vm._v("訂單建立日期")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.returnOrder.created_at,
      expression: "returnOrder.created_at"
    }],
    staticClass: "form-control",
    attrs: {
      id: "created_at",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.returnOrder, "created_at", $event.target.value);
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "col-md-2"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.returnOrder.creator,
      expression: "returnOrder.creator"
    }],
    staticClass: "form-control",
    attrs: {
      id: "creator",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.returnOrder, "creator", $event.target.value);
      }
    }
  })])])]), _vm._v(" "), _c("div", {
    staticClass: "row"
    ...
    domProps: {
      value: _vm.current_consumer.act || "無"
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "col-md-4"
  }, [_c("div", {
    ...
    attrs: {
      "for": "show_invoiceAddress"
    }
  }, [_vm._v("發票地址")]), _vm._v(" "), _c("input", {
    staticClass: "form-control",
    attrs: {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.returnOrder.taxType,
      expression: "returnOrder.taxType"
    }],
    staticClass: "form-control",
    attrs: {
      name: "taxType",
    ...
    on: {
      change: [function ($event) {
        ...
        _vm.$set(_vm.returnOrder, "taxType", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }, _vm.changeTax]
    }
  }, [_c("option", {
    attrs: {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.returnOrder.comment,
      expression: "returnOrder.comment"
    }],
    staticClass: "form-control",
    staticStyle: {
      height: "100%"
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.returnOrder, "comment", $event.target.value);
      }
    }
    ...
    attrs: {
      ...
      details: _vm.returnOrder.details,
      sales_order_id: _vm.returnOrder.id
    },
    on: {
...
/***/ "./resources/js/components/Orders/ReturnUpdateForm.vue":
/*!*************************************************************!*\
  !*** ./resources/js/components/Orders/ReturnUpdateForm.vue ***!
  \*************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ReturnUpdateForm_vue_vue_type_template_id_642fef28___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ReturnUpdateForm.vue?vue&type=template&id=642fef28& */ "./resources/js/components/Orders/ReturnUpdateForm.vue?vue&type=template&id=642fef28&");
/* harmony import */ var _ReturnUpdateForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ReturnUpdateForm.vue?vue&type=script&lang=js& */ "./resources/js/components/Orders/ReturnUpdateForm.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _ReturnUpdateForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _ReturnUpdateForm_vue_vue_type_template_id_642fef28___WEBPACK_IMPORTED_MODULE_0__["render"],
  _ReturnUpdateForm_vue_vue_type_template_id_642fef28___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/Orders/ReturnUpdateForm.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/Orders/ReturnUpdateForm.vue?vue&type=script&lang=js&":
/*!**************************************************************************************!*\
  !*** ./resources/js/components/Orders/ReturnUpdateForm.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ReturnUpdateForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./ReturnUpdateForm.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Orders/ReturnUpdateForm.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ReturnUpdateForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/Orders/ReturnUpdateForm.vue?vue&type=template&id=642fef28&":
/*!********************************************************************************************!*\
  !*** ./resources/js/components/Orders/ReturnUpdateForm.vue?vue&type=template&id=642fef28& ***!
  \********************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_ReturnUpdateForm_vue_vue_type_template_id_642fef28___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!../../../../node_modules/vue-loader/lib??vue-loader-options!./ReturnUpdateForm.vue?vue&type=template&id=642fef28& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Orders/ReturnUpdateForm.vue?vue&type=template&id=642fef28&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_ReturnUpdateForm_vue_vue_type_template_id_642fef28___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_ReturnUpdateForm_vue_vue_type_template_id_642fef28___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/orders/returns/edit.js":
/*!*********************************************!*\
  !*** ./resources/js/orders/returns/edit.js ***!
  \*********************************************/
/*! no static exports found */
...
Vue.component('return-update-form', __webpack_require__(/*! ./../../components/Orders/ReturnUpdateForm.vue */ "./resources/js/components/Orders/ReturnUpdateForm.vue")["default"]);
...
var app = new Vue({
  ...
  created: function created() {
    ...
    var getReturnOrderInfo = $('#getReturnOrderInfo').text();
    $.showLoadingModal();
    axios.get(getReturnOrderInfo).then(function (response) {
      _this2.returnOrder = response.data.returnOrder;
      _this2.returnOrder.details = response.data.details;
      $('#consumer_id').val(_this2.returnOrder.consumer_id);
      _this2.getConsumerData({
        id: _this2.returnOrder.consumer_id
      });

      // 計算金額
      var $total_price = 0;
      for (var i = 1; i <= _this2.returnOrder.details.length; i++) {
        var qty = _this2.returnOrder.details[i - 1].quantity;
        var price = _this2.returnOrder.details[i - 1].price;
        var discount = _this2.returnOrder.details[i - 1].discount;
        var subTotal = Math.round(price * qty * discount * 10000) / 10000;
        $total_price = $total_price + subTotal;
      }
      $('#beforePrice').val($total_price);
      var taxType = _this2.returnOrder.taxType;
      var tax = taxType == "1" ? Math.round($total_price * 0.05 * 10000) / 10000 : 0;
      $('#tax_price').val(tax);
      $total_price = Math.round(($total_price + tax) * 10000) / 10000;
      _this2.$refs.returnOrderform.showTotalPrice($total_price);
      $.closeModal();
    });
  }
});
...
module.exports = __webpack_require__(/*! C:\AppServ\www\Shangda\resources\js\orders\returns\edit.js */"./resources/js/orders/returns/edit.js");
