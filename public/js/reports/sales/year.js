              ...
              _c(
                ...
                [
                  _vm._l(_vm.reports, function(report) {
                    return _c("tr", { key: report[0] }, [
                      _c("td", [_vm._v(_vm._s(report[0]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(report[1]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(report[2]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(report[3]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(report[4]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(report[5]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(report[6]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(report[7]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(report[8]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(report[9]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(report[10]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(report[11]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(report[12]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(report[13]))])
                    ])
                  }),
                  _vm._v(" "),
                  _c(
                    "tr",
                    _vm._l(_vm.month_total, function(el) {
                      return _c("td", { key: el }, [
                        _c("strong", [_vm._v(_vm._s(el))])
                      ])
                    }),
                    0
                  )
  ...
  methods: {
    refreshData: function refreshData(e) {
      ...
      axios.post(getSalesYearData, this.filters).then(function (response) {
        ...
        _this.reports.forEach(function (report) {
