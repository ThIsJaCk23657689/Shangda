...
<div class="row justify-content-center">
    <div class="col-md-10">
        <form id="ProduceCreateForm" method="POST" action="#" @submit.prevent="createProduceForm">
    ...
    methods: {
        ...
        createProduceForm(e){
            ...
            axios.post(url, data).then(response => {
                ...
                axios.post(detail_url, detail_data).then(response => {
