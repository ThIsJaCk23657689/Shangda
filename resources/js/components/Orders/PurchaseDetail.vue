    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-6 mb-2">
                <select id="material_id" class="form-control" name="material_id" @change="getMaterialData">
            ...
            <tbody>
                <tr v-for="(detail, index) in details" :key="index">
                    ...
                    <td>
                        ...
                        <input type="hidden" name="material[id][]" :value="detail.material.id">
                    </td>
                    <td>
                        {{ detail.material.internationalNum }}
                    </td>
                    <td>
                        <input :id="'qty_' + (index + 1)" type="text" class="form-control" name="quantity[]" :value="detail.quantity" @change="calculateSubtotal(index+1)">
                    </td>
                    <td>
                        <input :id="'unitPrice_' + (index + 1)" type="text" class="form-control" name="material[unitPrice][]" :value="detail.material.unitPrice" @change="calculateSubtotal(index+1)">
                    </td>
                    <td>
                        <input :id="'discount_' + (index + 1)" type="text" class="form-control" name="discount[]" :value="detail.discount" @change="calculateSubtotal(index+1)">
                    </td>
                    <td>
                        <span :id="'subtotal_' + (index + 1)">0</span>
                    </td>
                    <td>
                        <input type="text" class="form-control" :value="detail.comment">
                    </td>
                    <td>
