            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="individual_name" name="individual_name" type="text" class="form-control" v-model="consumer.name" required autocomplete="off" placeholder="例：王大明">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="individual_shortName">簡稱</label>
                        <input id="individual_shortName" name="individual_shortName" type="text" class="form-control" v-model="consumer.shortName" autocomplete="off" placeholder="例：明哥">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="individual_birthday" name="individual_birthday" type="text" class="form-control" v-model="consumer.birthday" autocomplete="off" placeholder="例：1950-01-01">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="individual_monthlyCheckDate" name="individual_monthlyCheckDate" class="form-control mb-2" v-model="consumer.monthlyCheckDate" disabled>
                            <option value="0">請選擇...</option>
                            <option v-for="n in 31" :key="n" :value="n">{{ n }}</option>
                        </select>
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" name="individual_monthlyCheck" id="individual_monthlyCheck" value="1">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input id="individual_uncheckedAmount" name="individual_uncheckedAmount" type="text" class="form-control" v-model="consumer.uncheckedAmount" autocomplete="off" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input id="individual_totalConsumption" name="individual_totalConsumption" type="text" class="form-control" v-model="consumer.totalConsumption" autocomplete="off" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="individual_comment" name="individual_comment" type="text" class="form-control" rows="5" v-model="consumer.comment"></textarea>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input id="individual_phone" name="individual_phone" type="text" class="form-control" v-model="consumer.phone" autocomplete="off" placeholder="例：0912345678" required>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input id="individual_tel" name="individual_tel" type="text" class="form-control" v-model="consumer.tel" autocomplete="off" placeholder="例：0412345678">
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input id="individual_lineID" name="individual_lineID" type="text" class="form-control" v-model="consumer.lineID" autocomplete="off">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div id="individual_address_twzipcode" class="form-group">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <input id="individual_address_others" type="text" class="form-control" name="individual_address_others" v-model="consumer.address_others" required autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
