...
@section('content')
    ...
    <section id="register" class="header">
        ...
        {{-- <span id="ConsumerRegisterURL" class="d-none">{{ route('consumers.register.api') }}</span> --}}
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-10">
                    ...
                    {{-- 個人帳戶註冊 --}}
                    <form id="individual_form" method="POST" action="{{ route('consumers.register.api') }}" enctype="multipart/form-data" style="{{ ( old('account_type') == 'individual' )? '' : 'display: none' }}">
                        @csrf
                    ...
                    {{-- 公司帳戶註冊 --}}
                    <form id="company_form" method="POST" action="{{ route('consumers.register.api') }}" enctype="multipart/form-data" style="{{ ( old('account_type') == 'company' )? '' : 'display: none' }}">
                        @csrf
