...
Route::prefix('/backend')->group(function(){
    ...
    Route::prefix('/consumers')->group(function(){
        ...
        Route::get('taxID','ConsumerController@getDataByTaxID')->name('consumers.getData');
    ...
    Route::prefix('/orders')->group(function(){
        ...
        Route::get('/billing/pdf/{consumer_id?}/{start_at?}/{end_at?}/{show_detail?}', 'Orders\BillingController@generatePDF')->name('billing.pdf');
    });
