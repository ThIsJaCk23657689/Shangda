    ...
    {   
        ...
        if($account_type == 'individual'){
            $rules = [
                ...
                'individual_act' => 'required|string|min:6|max:30|unique:consumers,act',
                'individual_pwd' => 'required|string|min:6|max:30|confirmed',
            ...
            $rules = [
                ...
                'company_act' => 'required|string|min:6|max:30|unique:consumers,act',
                'company_pwd' => 'required|string|min:6|max:30|confirmed',

                'company_picture' => 'nullable|image|mimes:jpeg,png,jpg|max:2048',
                'company_name' => 'required|string|min:2|max:255',
                'company_shortName' => 'nullable|string|min:1|max:255',
                'company_taxID' => 'required|max:8|string',
                'company_principal' => 'required|string|min:2|max:255',
                'company_idNumber' => 'required|string|size:10|tw_id',
